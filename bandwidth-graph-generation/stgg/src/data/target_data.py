...
from stgg.src.data.smiles import (
    TOKEN2ATOMFEAT,
    TOKEN2BONDFEAT,
    get_max_valence,
    molgraph2smiles,
...
from stgg.src.data.dfs import dfs_successors
from stgg.src.util import pad_square
...
class Data:
    ...
    def from_smiles(smiles):
        ...
        successors = dfs_successors(mollinegraph, source=start, randomize_neighbors=False)
        predecessors = dict()
