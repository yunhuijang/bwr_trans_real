...
class EDPGNNGeneratorLightningModule(BaseGeneratorLightningModule):
...
if __name__ == "__main__":
    ...
    EDPGNNGeneratorLightningModule.add_args(parser)

    hparams = parser.parse_args()
    
    wandb.init(name=f'{hparams.dataset_name}-{hparams.model}', project='bwr', group=f'{hparams.group}',
            mode='disabled')
    wandb.config.update(hparams)
    
    model = EDPGNNGeneratorLightningModule(hparams)
