...
from lstm_notoken_generator import LSTMNoTokenGenerator
from graph_gen.data.nx_dataset import LSTMNoTokenDataset
from graph_gen.models.model_utils import compute_notoken_accuracy, compute_mse


class LSTMNoTokenGeneratorLightningModule(BaseGeneratorLightningModule):
    ...
    def setup_model(self, hparams):
        self.model = LSTMNoTokenGenerator(
    ...
    def sample(self, num_samples):
        ...
        while offset < num_samples:
            ...
            graphs_list = [LSTMNoTokenDataset.untokenize(sequence) for sequence in sequences.tolist()]
    ...
    def train_dataloader(self):
        return DataLoader(
            ...
            shuffle=True,
            collate_fn=LSTMNoTokenDataset.collate_fn,
    ...
    def add_args(parser):
        ...
        #
        parser.add_argument("--model", type=str, default='lstm_notoken')
...
if __name__ == "__main__":
    ...
    LSTMNoTokenGeneratorLightningModule.add_args(parser)
    ...
    model = LSTMNoTokenGeneratorLightningModule(hparams)
